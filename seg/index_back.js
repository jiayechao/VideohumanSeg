...
function createBgData() {
  ...
  videoCanvasCtx.drawImage(bg, 0, 0)
...
async function callbackForVideo(result) {
  ...
  //   console.log(legendColors.length)
  ...
  console.log(result)
  const mask = await result.categoryMask.canvas.convertToBlob();
  console.log(mask)
  canvasCtx.drawImage(mask, 0, 0, width, height);

  canvasCtx.globalCompositeOperation =  'source-in'; // composition magic
